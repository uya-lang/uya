...
int32_t  _return_main;
  ...
  int32_t result = ({ int32_t __match_temp_0; if (((point.x == 0) && (point.y == 0))) { __match_temp_0 = 0; }else if (((point.x == 10) && (point.y == 20))) { __match_temp_0 = 1; }else if (1) { __match_temp_0 = -1; } __match_temp_0; });
  _return_main = result;
