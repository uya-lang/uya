...
int32_t  _return_main;
  ...
  int32_t result = ({ int32_t __match_temp_0; if (((point.x == 0) && (point.y == 0))) { __match_temp_0 = 0; }else if (1) { int32_t x_val = 1.x; int32_t y_val = 1.y; __match_temp_0 = (x_val + y_val); }else if (1) { __match_temp_0 = -1; } __match_temp_0; });
  _return_main = result;
