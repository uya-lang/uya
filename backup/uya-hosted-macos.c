...
const int32_t libc_EDEADLK = 11;
const int32_t libc_ENAMETOOLONG = 63;
const int32_t libc_ENOLCK = 77;
const int32_t libc_ENOSYS = 78;
const int32_t libc_ENOTEMPTY = 66;
const int32_t libc_ELOOP = 62;
const int32_t libc_EWOULDBLOCK = 35;
const int32_t libc_ENOMSG = 91;
const int32_t libc_EIDRM = 90;
const int32_t libc_EILSEQ = 92;
const int32_t libc_EAGAIN = 35;
const int32_t libc_ENOTSOCK = 38;
const int32_t libc_EDESTADDRREQ = 39;
const int32_t libc_EMSGSIZE = 40;
const int32_t libc_EPROTOTYPE = 41;
const int32_t libc_ENOPROTOOPT = 42;
const int32_t libc_EPROTONOSUPPORT = 43;
const int32_t libc_ESOCKTNOSUPPORT = 44;
const int32_t libc_EOPNOTSUPP = 102;
const int32_t libc_EPFNOSUPPORT = 46;
const int32_t libc_EAFNOSUPPORT = 47;
const int32_t libc_EADDRINUSE = 48;
const int32_t libc_EADDRNOTAVAIL = 49;
const int32_t libc_ENETDOWN = 50;
const int32_t libc_ENETUNREACH = 51;
const int32_t libc_ENETRESET = 52;
const int32_t libc_ECONNABORTED = 53;
const int32_t libc_ECONNRESET = 54;
const int32_t libc_ENOBUFS = 55;
const int32_t libc_EISCONN = 56;
const int32_t libc_ENOTCONN = 57;
const int32_t libc_ESHUTDOWN = 58;
const int32_t libc_ETIMEDOUT = 60;
const int32_t libc_ECONNREFUSED = 61;
const int32_t libc_EHOSTDOWN = 64;
const int32_t libc_EHOSTUNREACH = 65;
const int32_t libc_EALREADY = 37;
const int32_t libc_EINPROGRESS = 36;
...
__attribute__((used)) const int32_t HEAP_MAP_ANONYMOUS = 4096;
...
__attribute__((used)) const int64_t _FOPEN_W_FLAGS = ((1 | 512) | 1024);

__attribute__((used)) const int64_t _FOPEN_A_FLAGS = ((1 | 512) | 8);

__attribute__((used)) const int64_t _FOPEN_W_PLUS_FLAGS = ((2 | 512) | 1024);

__attribute__((used)) const int64_t _FOPEN_A_PLUS_FLAGS = ((2 | 512) | 8);
...
__attribute__((used)) const int32_t _TMPFILE_O_FLAGS = 2562;
...
const int64_t libc_AT_FDCWD = (-2);
const int32_t libc_AT_REMOVEDIR = 128;
const int32_t libc_AT_SYMLINK_NOFOLLOW = 32;
const int64_t libc_SYS_read = 3;
const int64_t libc_SYS_write = 4;
const int64_t libc_SYS_writev = 121;
const int64_t libc_SYS_open = 5;
const int64_t libc_SYS_close = 6;
const int64_t libc_SYS_stat = 188;
const int64_t libc_SYS_fstat = 0;
const int64_t libc_SYS_lstat = 190;
const int64_t libc_SYS_lseek = 199;
const int64_t libc_SYS_mmap = 197;
const int64_t libc_SYS_munmap = 73;
const int64_t libc_SYS_mprotect = 74;
const int64_t libc_SYS_brk = 0;
const int64_t libc_SYS_ioctl = 54;
const int64_t libc_SYS_access = 33;
const int64_t libc_SYS_dup = 41;
const int64_t libc_SYS_dup2 = 0;
const int64_t libc_SYS_dup3 = 0;
const int64_t libc_SYS_getpid = 20;
const int64_t libc_SYS_getppid = 39;
const int64_t libc_SYS_fork = 2;
const int64_t libc_SYS_execve = 59;
const int64_t libc_SYS_exit = 1;
const int64_t libc_SYS_waitpid = 7;
const int64_t libc_SYS_kill = 37;
const int64_t libc_SYS_tgkill = 0;
const int64_t libc_SYS_getcwd = 0;
const int64_t libc_SYS_chdir = 12;
const int64_t libc_SYS_mkdir = 136;
const int64_t libc_SYS_rmdir = 137;
const int64_t libc_SYS_unlink = 10;
const int64_t libc_SYS_rename = 128;
const int64_t libc_SYS_readlink = 58;
const int64_t libc_SYS_getdents64 = 344;
const int64_t libc_SYS_setrlimit = 195;
const int64_t libc_SYS_getrlimit = 194;
const int64_t libc_SYS_clone = 0;
const int64_t libc_SYS_futex = 0;
const int64_t libc_SYS_set_tid_address = 0;
const int64_t libc_SYS_eventfd = 0;
const int64_t libc_SYS_sched_setaffinity = 0;
const int64_t libc_SYS_sched_getaffinity = 0;
const int64_t libc_SYS_sched_yield = 0;
const int64_t libc_SYS_nanosleep = 0;
const int64_t libc_SYS_clock_gettime = 0;
const int64_t libc_SYS_gettimeofday = 116;
const int64_t libc_SYS_fcntl = 0;
const int64_t libc_SYS_pipe2 = 0;
const int64_t libc_SYS_socket = 97;
const int64_t libc_SYS_bind = 104;
const int64_t libc_SYS_listen = 106;
const int64_t libc_SYS_accept = 30;
const int64_t libc_SYS_connect = 98;
const int64_t libc_SYS_send = 133;
const int64_t libc_SYS_recv = 29;
const int64_t libc_SYS_sendto = 133;
const int64_t libc_SYS_recvfrom = 29;
const int64_t libc_SYS_shutdown = 134;
const int64_t libc_SYS_setsockopt = 105;
const int64_t libc_SYS_getsockopt = 118;
const int64_t libc_SYS_getsockname = 32;
const int64_t libc_SYS_getpeername = 31;
const int64_t libc_SYS_openat = 463;
const int64_t libc_SYS_newfstatat = 469;
const int64_t libc_SYS_faccessat = 466;
const int64_t libc_SYS_unlinkat = 472;
const int64_t libc_SYS_mkdirat = 475;
const int64_t libc_SYS_renameat = 465;
const int64_t libc_SYS_readlinkat = 473;
const int64_t libc_SYS_epoll_create1 = 0;
const int64_t libc_SYS_epoll_ctl = 0;
const int64_t libc_SYS_epoll_wait = 0;
const int64_t libc_SYS_epoll_pwait = 0;
const int64_t libc_SYS_getuid = 24;
const int64_t libc_SYS_getgid = 47;
const int64_t libc_SYS_setuid = 23;
const int64_t libc_SYS_setgid = 181;
const int64_t libc_SYS_geteuid = 25;
const int64_t libc_SYS_getegid = 43;
const int64_t libc_SYS_gettid = 286;
const int32_t libc_AF_INET = 2;
const int32_t libc_AF_INET6 = 30;
...
const int32_t libc_SOL_SOCKET = 65535;
const int32_t libc_SO_REUSEADDR = 4;
const int32_t libc_SO_REUSEPORT = 512;
const int32_t libc_SO_SNDBUF = 4097;
const int32_t libc_TCP_NODELAY = 1;
const int32_t libc_SO_RCVTIMEO = 4102;
const int32_t libc_SO_SNDTIMEO = 4101;
...
const int64_t libc_O_CREAT = 512;
const int64_t libc_O_EXCL = 2048;
const int64_t libc_O_TRUNC = 1024;
const int64_t libc_O_APPEND = 8;
const int64_t libc_O_DIRECTORY = 1048576;
const int32_t libc_O_NONBLOCK = 4;
const int32_t libc_O_CLOEXEC = 16777216;
const int32_t libc_EFD_SEMAPHORE = 1;
const int32_t libc_EFD_NONBLOCK = 4;
const int32_t libc_EFD_CLOEXEC = 16777216;
...
const int32_t libc_F_GETPATH = 50;
const int32_t libc_F_DUPFD_CLOEXEC = 67;
...
const int32_t libc_MAP_ANONYMOUS = 4096;
...
__attribute__((used)) struct err_union_intptr_t sys_write(int32_t fd, const char * buf, size_t count) {
    ...
    (void)count;
        {
        struct err_union_intptr_t _uya_ret = ({ struct err_union_int64_t _uya_asbang_src = uya_macos_write(fd, (const char *)buf, count); struct err_union_intptr_t _uya_asbang; if (_uya_asbang_src.error_id != 0) { _uya_asbang.error_id = _uya_asbang_src.error_id; _uya_asbang.value = (intptr_t){0}; } else { _uya_asbang.error_id = 0; _uya_asbang.value = (intptr_t)(_uya_asbang_src.value); } _uya_asbang; });
        return _uya_ret;
        }
...
__attribute__((used)) struct err_union_int32_t sys_access(const char * pathname, int32_t mode) {
    ...
    (void)mode;
        {
        struct err_union_int32_t _uya_ret = uya_macos_access((const char *)pathname, mode);
        return _uya_ret;
        }
...
__attribute__((used)) struct err_union_intptr_t sys_readlink(const char * pathname, char * buf, size_t bufsiz) {
    ...
    (void)bufsiz;
        {
        struct err_union_intptr_t _uya_ret = ({ struct err_union_int64_t _uya_asbang_src = uya_macos_readlink((const char *)pathname, (char *)buf, bufsiz); struct err_union_intptr_t _uya_asbang; if (_uya_asbang_src.error_id != 0) { _uya_asbang.error_id = _uya_asbang_src.error_id; _uya_asbang.value = (intptr_t){0}; } else { _uya_asbang.error_id = 0; _uya_asbang.value = (intptr_t)(_uya_asbang_src.value); } _uya_asbang; });
        return _uya_ret;
        }
        return (struct err_union_intptr_t){0};
}
...
int32_t main(int32_t argc, char **argv) {
    ...
    uint8_t * * * const envpp = _NSGetEnviron();
    if (envpp != NULL) {
        saved_envp = envpp[0];
    } else {
        saved_envp = NULL;
