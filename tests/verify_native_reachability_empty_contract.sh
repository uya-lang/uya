...
# Phase 10：固定 native_build_reachability_empty()
...
require_pattern "$TODO_DOC" 'native_build_reachability_empty\(\).*body-complete' \
    "todo 缺少 native_build_reachability_empty 合同任务"
...
require_pattern "$STAGE1_TEST" 'verify_native_reachability_empty_contract\.sh' \
    "stage1 未纳入 native_build_reachability_empty 合同"
