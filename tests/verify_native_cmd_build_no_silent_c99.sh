...
run_cmd_build_self_preflight_check() {
    ...
    grep -q 'native_hosted_entry_child_frontier: first_pending_callee=build_compiler_driver_run parent_stmt=37 child_prefix=1 child_prefix_stmts=4 child_next_stmt=4 child_next_kind=if' "$stderr"
