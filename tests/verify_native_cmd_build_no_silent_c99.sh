...
run_cmd_build_self_preflight_check() {
    ...
    grep -q 'native_hosted_reachable_body_frontier: function=parse_build_args prefix_stmts=22 next_stmt=22 next_kind=AST_VAR_DECL reason=partial_core_body' "$stderr"
