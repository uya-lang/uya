...
run_cmd_build_self_preflight_check() {
    ...
    grep -q 'native_hosted_entry_frontier: wrapper_covered=1 first_pending_callee=build_compiler_driver_run first_pending_callee_prefix=1 first_pending_callee_prefix_stmts=19 first_pending_callee_next_stmt=19 first_pending_callee_next_kind=if' "$stderr"
