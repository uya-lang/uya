...
fn lower_generic_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_stmts: lower_generic_vector(),
        core_exprs: lower_generic_vector(),
        core_places: lower_generic_vector(),
        core_cleanup_edges: lower_generic_vector(),
        core_semantic_facts: lower_generic_vector(),
