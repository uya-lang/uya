...
fn lower_err_union_program() LoweredProgram {
    return LoweredProgram{
        ...
        body_ops: lower_err_union_vector(),
        core_bodies: lower_err_union_vector(),
        core_stmts: lower_err_union_vector(),
        core_exprs: lower_err_union_vector(),
        core_places: lower_err_union_vector(),
        core_cleanup_edges: lower_err_union_vector(),
        core_semantic_facts: lower_err_union_vector(),
