#!/usr/bin/env bash
#
# Focused real-CLI gate for imported extern signatures that currently stop at
...
tmp_dir="$(mktemp -d /tmp/uya-mir-c99-extern-common.XXXXXX)"
...
run_case tests/test_mem_allocator.uya
run_case tests/test_ffi_cast.uya
run_case tests/extern_ffi_no_struct.uya

echo "OK: MIR-C99 imported extern signatures no longer stop at extern_signature_requires_i32_scalars"
