...
require_pattern "$NO_SILENT_TEST" 'native_hosted_reachable_body_frontier: function=compile_stats_record_and_release_typed_program prefix_stmts=13 next_stmt=13 next_kind=AST_ASSIGN reason=partial_core_body' \
    "no-silent-C99 测试缺少 compile_stats table_used_bytes frontier"
