...
fn lower_dump_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_bodies: lower_dump_vector(),
        core_stmts: lower_dump_vector(),
        core_exprs: lower_dump_vector(),
        core_places: lower_dump_vector(),
        core_cleanup_edges: lower_dump_vector(),
        core_semantic_facts: lower_dump_vector(),
