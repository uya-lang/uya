...
fn lower_interface_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_stmts: lower_interface_vector(),
        core_exprs: lower_interface_vector(),
        core_places: lower_interface_vector(),
        core_cleanup_edges: lower_interface_vector(),
        core_semantic_facts: lower_interface_vector(),
