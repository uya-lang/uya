...
fn lower_roots_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_stmts: lower_roots_vector(),
        core_exprs: lower_roots_vector(),
        core_places: lower_roots_vector(),
        core_cleanup_edges: lower_roots_vector(),
        core_semantic_facts: lower_roots_vector(),
