...
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=4 covered_branch=line-directives next_branch=--safety-proof next_kind=AST_IF_STMT reason=partial_else_if_chain' \
    "cmd/build subset doc 缺少 line-directives branch frontier 诊断形状"
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=5 covered_branch=safety-proof next_branch=--opt=0 next_kind=AST_IF_STMT reason=partial_else_if_chain' \
    "cmd/build subset doc 缺少 safety-proof branch frontier 诊断形状"
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=6 covered_branch=opt-level next_branch=--nostdlib next_kind=AST_IF_STMT reason=partial_else_if_chain' \
...
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=8 covered_branch=--project-root-missing-arg next_branch=--project-root-arg-read next_kind=AST_ASSIGN reason=partial_else_if_chain' \
    "cmd/build subset doc 缺少 --project-root 缺参子切片 frontier 诊断形状"
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=8 covered_branch=--project-root-arg-read next_branch=--project-root-length next_kind=AST_VAR_DECL reason=partial_else_if_chain' \
    "cmd/build subset doc 缺少 --project-root 参数读取子切片 frontier 诊断形状"
require_pattern "$SUBSET_DOC" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=8 covered_branch=--project-root-length next_branch=--project-root-success next_kind=AST_CALL_EXPR reason=partial_else_if_chain' \
    "cmd/build subset doc 缺少 --project-root 长度检查子切片 frontier 诊断形状"
...
require_pattern "$NO_SILENT_TEST" 'native_hosted_reachable_loop_body_branch_frontier: function=parse_build_args parent_stmt=23 loop_stmt=17 covered_branch=--split-c-dir-separate-disabled next_branch=--split-c-dir-separate-success next_kind=AST_IF_STMT reason=partial_else_if_chain' \
    "no-silent-C99 测试缺少 separate split-c disabled 完成后的 success frontier"
