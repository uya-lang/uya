...
fn lower_sort_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_stmts: lower_sort_vector(),
        core_exprs: lower_sort_vector(),
        core_places: lower_sort_vector(),
        core_cleanup_edges: lower_sort_vector(),
        core_semantic_facts: lower_sort_vector(),
