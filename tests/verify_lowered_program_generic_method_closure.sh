...
fn lower_method_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_bodies: lower_method_vector(),
        core_stmts: lower_method_vector(),
        core_exprs: lower_method_vector(),
        core_places: lower_method_vector(),
        core_cleanup_edges: lower_method_vector(),
        core_semantic_facts: lower_method_vector(),
