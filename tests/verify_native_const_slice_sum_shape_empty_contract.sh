...
# Phase 10：固定 native_build_const_slice_sum_shape_empty()
...
require_pattern "$TODO_DOC" 'native_build_const_slice_sum_shape_empty\(\)' \
    "todo 缺少 native_build_const_slice_sum_shape_empty 合同任务"
require_pattern "$TODO_DOC" 'body-complete 合同' \
    "todo 缺少 native_build_const_slice_sum_shape_empty body-complete 合同意图"
...
require_pattern "$STAGE1_TEST" 'verify_native_const_slice_sum_shape_empty_contract\.sh' \
    "stage1 未纳入 native_build_const_slice_sum_shape_empty 合同"
