...
if ((ZERO < ONE)) {
    if ((ONE < TWO)) {
        if ((TWO < THREE)) {
            if ((THREE < FOUR)) {
                if ((FOUR < FIVE)) {
                    const enum Level level0 = ZERO;
                    const enum Level level1 = ONE;
                    const enum Level level2 = TWO;
                    const enum Level level3 = THREE;
                    const enum Level level4 = FOUR;
                    const enum Level level5 = FIVE;
                    if ((level0 == ZERO)) {
                        if ((level1 == ONE)) {
                            if ((level2 == TWO)) {
                                if ((level3 == THREE)) {
