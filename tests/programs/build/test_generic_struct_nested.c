...
int32_t uya_main(void) {
struct Box_i32 b1 = (struct Box_i32){.data = 42};
if ((b1.data != 42)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
struct Box_i32 inner_box = (struct Box_i32){.data = 100};
struct DoubleBox_i32 db = (struct DoubleBox_i32){.inner = inner_box, .extra = 999};
