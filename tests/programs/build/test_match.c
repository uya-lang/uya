...
int32_t uya_main(void) {
const int32_t x = 1;
const int32_t r1 = ({ const int32_t _uya_m = x; int32_t _uya_r; if (_uya_m == 0) _uya_r = 10; else if (_uya_m == 1) _uya_r = 20; else if (_uya_m == 2) _uya_r = 30; else { _uya_r = 40; } _uya_r; });
if ((r1 != 20)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t r2 = ({ int32_t _uya_m = 42; int32_t _uya_r; { int32_t v = _uya_m; _uya_r = v; } _uya_r; });
if ((r2 != 42)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const int32_t r3 = ({ int32_t _uya_m = 99; int32_t _uya_r; if (_uya_m == 0) _uya_r = 0; else if (_uya_m == 1) _uya_r = 1; else { _uya_r = 99; } _uya_r; });
if ((r3 != 99)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const enum Color c = Green;
const int32_t r4 = ({ const enum Color _uya_m = c; int32_t _uya_r; if (_uya_m == 1) _uya_r = 1; else if (_uya_m == 2) _uya_r = 2; else if (_uya_m == 3) _uya_r = 3; else { _uya_r = 0; } _uya_r; });
if ((r4 != 2)) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
const bool b = true;
const int32_t r5 = ({ const bool _uya_m = b; int32_t _uya_r; if (_uya_m == 1) _uya_r = 1; else if (_uya_m == 0) _uya_r = 0; else { _uya_r = 0; } _uya_r; });
if ((r5 != 1)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
