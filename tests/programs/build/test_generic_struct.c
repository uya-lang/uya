...
int32_t uya_main(void) {
struct Pair_i32_i32 p1 = (struct Pair_i32_i32){.key = 1, .value = 100};
struct Pair_i32_f64 p2 = (struct Pair_i32_f64){.key = 2, .value = 3.1400000000000001};
struct Box_i32 box_i32 = (struct Box_i32){.data = 42};
int32_t _uya_ret = 0;
return _uya_ret;
}
