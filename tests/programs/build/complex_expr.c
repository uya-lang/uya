...
int32_t _double(int32_t x);
int32_t uya_main(void);

int32_t _double(int32_t x) {
    int32_t _uya_ret = (x * 2);
    return _uya_ret;
}
...
const int32_t a = 5;
const int32_t b = 10;
const int32_t result1 = (((a + b) * 2) - _double(a));
if ((result1 != 20)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t result2 = (_double(a) + (_double(b) * 2));
if ((result2 != 50)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const bool result3 = (((a < b) && (b > a)) && ((a + b) == 15));
if ((result3 != true)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t result4 = (((-a) + b) - (-b));
if ((result4 != 15)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
