...
// 字符串常量
static const uint8_t str0[] = "Hello from macro!\n";
...
const int32_t func_result = add_numbers(32, 10);
if ((func_result != 42)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t base = 42;
if ((base != 42)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const int32_t wrapped = 42;
if ((wrapped != 42)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const int32_t outer_result = (32 + 10);
if ((outer_result != 42)) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
const int32_t multi_level = ((100 + 50) * 2);
if ((multi_level != 300)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
const int32_t complex_result = add_numbers((10 + 5), 20);
if ((complex_result != 35)) {
    int32_t _uya_ret = 6;
    return _uya_ret;
}
int32_t _uya_ret = 0;
