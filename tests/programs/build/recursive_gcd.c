...
int32_t gcd(int32_t a, int32_t b) {
    if ((b == 0)) {
        ...
        int32_t _uya_ret = gcd(b, (a % b));
        return _uya_ret;
    }
}

int32_t uya_main(void) {
const int32_t g1 = gcd(48, 18);
if ((g1 != 6)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t g2 = gcd(18, 48);
if ((g2 != 6)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const int32_t g3 = gcd(17, 13);
if ((g3 != 1)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const int32_t g4 = gcd(100, 25);
if ((g4 != 25)) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
const int32_t g5 = gcd(42, 56);
if ((g5 != 14)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
