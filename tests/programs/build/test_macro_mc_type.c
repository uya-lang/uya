...
const int32_t i32_size = (struct TypeInfo){.name = (int8_t *)(uint8_t *)str0, .size = 4, .align = 4, .kind = 1, .is_integer = true, .is_float = false, .is_bool = false, .is_pointer = false, .is_array = false, .is_void = false}.size;
if ((i32_size != 4)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
