...
int32_t power(int32_t base, int32_t exp) {
    if ((exp <= 0)) {
        ...
        int32_t _uya_ret = (base * power(base, (exp - 1)));
        return _uya_ret;
    }
}

int32_t uya_main(void) {
const int32_t p1 = power(2, 0);
if ((p1 != 1)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const int32_t p2 = power(2, 1);
if ((p2 != 2)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const int32_t p3 = power(2, 5);
if ((p3 != 32)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const int32_t p4 = power(3, 4);
if ((p4 != 81)) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
const int32_t p5 = power(5, 3);
if ((p5 != 125)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
