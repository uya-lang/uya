...
bool is_even(int32_t n) {
    if ((n == 0)) {
        ...
        bool _uya_ret = is_odd((n - 1));
        return _uya_ret;
    }
}

int32_t uya_main(void) {
const bool e0 = is_even(0);
if ((e0 != true)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const bool e1 = is_even(1);
if ((e1 != false)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const bool e2 = is_even(2);
if ((e2 != true)) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const bool e5 = is_even(5);
if ((e5 != false)) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
const bool e8 = is_even(8);
if ((e8 != true)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
const bool o0 = is_odd(0);
if ((o0 != false)) {
    int32_t _uya_ret = 6;
    return _uya_ret;
}
const bool o1 = is_odd(1);
if ((o1 != true)) {
    int32_t _uya_ret = 7;
    return _uya_ret;
}
const bool o3 = is_odd(3);
if ((o3 != true)) {
    int32_t _uya_ret = 8;
    return _uya_ret;
}
const bool o6 = is_odd(6);
if ((o6 != false)) {
    int32_t _uya_ret = 9;
    return _uya_ret;
}
