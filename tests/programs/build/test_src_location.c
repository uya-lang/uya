...
int32_t test_func() {
    const uint8_t * const func = str3;
    if ((func == NULL)) {
        int32_t _uya_ret = 10;
        return _uya_ret;
    }
    const int32_t line1 = 56;
    const int32_t line2 = 57;
    if ((line2 != (line1 + 1))) {
        int32_t _uya_ret = 11;
        return _uya_ret;
    }
...
int32_t uya_main(void) {
const int32_t line = 10;
const int32_t col = 22;
if ((line <= 0)) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
...
const uint8_t * const func = str2;
if ((func == NULL)) {
    int32_t _uya_ret = 5;
    return _uya_ret;
}
const int32_t result = test_func();
if ((result != 0)) {
