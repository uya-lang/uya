...
double uya_IntOrFloat_as_f64(const struct uya_tagged_IntOrFloat * self);
bool uya_IntOrFloat_is_int(const struct uya_tagged_IntOrFloat * self);
int32_t uya_main(void);

double uya_IntOrFloat_as_f64(const struct uya_tagged_IntOrFloat * self) {
    double _uya_ret = ({ const struct uya_tagged_IntOrFloat _uya_m = (*self); double _uya_r; if (_uya_m._tag == 0) { int32_t x = _uya_m.u.i; _uya_r = (double)x; } else if (_uya_m._tag == 1) { double x = _uya_m.u.f; _uya_r = x; } _uya_r; });
    return _uya_ret;
}

bool uya_IntOrFloat_is_int(const struct uya_tagged_IntOrFloat * self) {
    bool _uya_ret = ({ const struct uya_tagged_IntOrFloat _uya_m = (*self); bool _uya_r; if (_uya_m._tag == 0) _uya_r = true; else if (_uya_m._tag == 1) _uya_r = false; _uya_r; });
    return _uya_ret;
}
...
const double as_float = uya_IntOrFloat_as_f64(&(vi));
if (((as_float < 41.899999999999999) || (as_float > 42.100000000000001))) {
    int32_t _uya_ret = 1;
    return _uya_ret;
}
const bool is_int_val = uya_IntOrFloat_is_int(&(vi));
if ((!is_int_val)) {
    int32_t _uya_ret = 2;
    return _uya_ret;
}
const double as_float2 = uya_IntOrFloat_as_f64(&(vf));
if (((as_float2 < 3.1299999999999999) || (as_float2 > 3.1499999999999999))) {
    int32_t _uya_ret = 3;
    return _uya_ret;
}
const bool is_int2 = uya_IntOrFloat_is_int(&(vf));
if (is_int2) {
    int32_t _uya_ret = 4;
    return _uya_ret;
}
