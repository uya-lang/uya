...
int32_t test_bit_and();
int32_t test_bit_or();
int32_t test_bit_xor();
int32_t test_bit_not();
int32_t test_shift_left();
int32_t test_shift_right();
int32_t test_precedence();
