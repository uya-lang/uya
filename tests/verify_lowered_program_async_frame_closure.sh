...
fn lower_async_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_bodies: lower_async_vector(),
        core_stmts: lower_async_vector(),
        core_exprs: lower_async_vector(),
        core_places: lower_async_vector(),
        core_cleanup_edges: lower_async_vector(),
        core_semantic_facts: lower_async_vector(),
