...
fn lower_struct_program() LoweredProgram {
    return LoweredProgram{
        ...
        core_bodies: lower_struct_vector(),
        core_stmts: lower_struct_vector(),
        core_exprs: lower_struct_vector(),
        core_places: lower_struct_vector(),
        core_cleanup_edges: lower_struct_vector(),
        core_semantic_facts: lower_struct_vector(),
