...
DEFER_RETURN_LOCAL_FIXTURE="$REPO_ROOT/tests/fixtures/mir_c99_cmd_build_full_language_defer_return_local.uya"
DEFER_RETURN_CONST_FIXTURE="$REPO_ROOT/tests/fixtures/mir_c99_cmd_build_full_language_defer_return_const.uya"
...
ERROR_BINDING_SUCCESS_FIXTURE="$REPO_ROOT/tests/fixtures/mir_c99_cmd_build_full_language_error_id_binding_success.uya"
ERROR_BINDING_ERROR_FIXTURE="$REPO_ROOT/tests/fixtures/mir_c99_cmd_build_full_language_error_id_binding_error.uya"
...
run_candidate_oracle_case full_language_defer_return_local "$DEFER_RETURN_LOCAL_FIXTURE"
run_candidate_oracle_case full_language_defer_return_const "$DEFER_RETURN_CONST_FIXTURE"
...
run_candidate_oracle_case full_language_error_id_binding_success "$ERROR_BINDING_SUCCESS_FIXTURE"
run_candidate_oracle_case full_language_error_id_binding_error "$ERROR_BINDING_ERROR_FIXTURE"
