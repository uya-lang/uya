...
fn lower_nested_err_union_program() LoweredProgram {
    return LoweredProgram{
        ...
        body_ops: lower_nested_err_union_vector(),
        core_bodies: lower_nested_err_union_vector(),
        core_stmts: lower_nested_err_union_vector(),
        core_exprs: lower_nested_err_union_vector(),
        core_places: lower_nested_err_union_vector(),
        core_cleanup_edges: lower_nested_err_union_vector(),
        core_semantic_facts: lower_nested_err_union_vector(),
