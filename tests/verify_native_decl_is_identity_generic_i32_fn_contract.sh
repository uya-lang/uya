...
require_pattern "$TODO_DOC" 'native_build_decl_is_identity_generic_i32_fn\(\.\.\.\)' \
...
require_pattern "$STAGE1_TEST" 'verify_native_decl_is_identity_generic_i32_fn_contract\.sh' \
    "stage1 未纳入 native_build_decl_is_identity_generic_i32_fn 合同"
