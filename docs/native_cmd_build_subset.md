...
- `cmd/build` 当前失败卡点必须继续由 `tests/verify_native_cmd_build_no_silent_c99.sh` 固定；失败时必须保留
  ...
  `native_hosted_reachable_body_frontier: function=parse_build_args prefix_stmts=18 next_stmt=18 next_kind=AST_VAR_DECL reason=partial_core_body`、
