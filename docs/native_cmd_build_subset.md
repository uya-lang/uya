...
- `cmd/build` 当前失败卡点必须继续由 `tests/verify_native_cmd_build_no_silent_c99.sh` 固定；失败时必须保留
  ...
  `native_hosted_emitter_import_preflight: status=ready imported_functions=481 imported_blocks=38 imported_insts=55 ...` 和
