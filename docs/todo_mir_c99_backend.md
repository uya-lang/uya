...
- [ ] `MIR-C99-FULL-SUPPORT-ASYNC-REAL-CLI`: 将 async 相关 completed-archive/generator
  ...
  - [ ] `MIR-C99-FULL-SUPPORT-ASYNC-REAL-CLI-BASIC-RUNTIME`: 将 ready/block_on、
    ...
    - 完成条件：脚本必须验证 `[MIR-C99]` 与
      ...
      C99 oracle 对齐。
  - [ ] `MIR-C99-FULL-SUPPORT-ASYNC-REAL-CLI-CONTROL-FLOW`: 将 if/else-if、while、for、
  ...
  - [ ] `MIR-C99-FULL-SUPPORT-ASYNC-REAL-CLI-FRAME-POOL-FALLBACK`: 将 frame
