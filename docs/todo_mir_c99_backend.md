...
- [ ] `MIR-C99-FULL-SUPPORT-GENERIC-COREBODY-LOWERING`: 将 full-language 主路径从
  ...
  - [ ] `MIR-C99-FULL-SUPPORT-GENERIC-COREBODY-FUNCTION-INVENTORY`: 从真实
  ...
  - [ ] `MIR-C99-FULL-SUPPORT-GENERIC-COREBODY-CLI-ENTRY`: 将真实 `--mir-c99`
