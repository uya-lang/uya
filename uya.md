...
- [21. 字符串与格式化（0.12）](#21-字符串与格式化012)
- [22. 优雅 0.12 泛型增量文档（可选特性）](#22-优雅-012-泛型增量文档向后-100-兼容零新关键字)
- [23. 优雅 0.12 显式宏（可选增量）](#23-优雅-012-显式宏可选增量)
- [24. 一句话总结](#24-一句话总结)
- [25. 未实现/将来](#25-未实现将来)
- [术语表](#术语表)
...
## 22 优雅 0.12 泛型增量文档（向后 100% 兼容，零新关键字）
...
- ✅ **泛型**：第 22 章 - 优雅 0.12 泛型增量文档
- ✅ **显式宏**：第 23 章 - 优雅 0.12 显式宏（可选增量）
- ✅ **类型别名**：第 22 章 6.2 节 - 类型别名实现
